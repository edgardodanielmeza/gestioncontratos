                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody id="provisionesTableBody">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border-b text-center">
                            <form action="{{route('provisiones.destroy',[$provision->idprovision])}}" method="POST">
									@csrf
									@method('DELETE')
                                    <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded mx-1">Eliminar</button>
