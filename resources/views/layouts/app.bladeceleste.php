        ...
        <nav class="bg-blue-500 p-6">
            <div class="container mx-auto flex justify-between items-center">
                <a class="text-white text-2xl" href="{{ url('/') }}">
                    {{ config('app.name', 'Gestion de Contratos') }}
                </a>
                <a href="{{ route('contratos.index') }}" class="bg-white text-blue-500 hover:bg-blue-700 hover:text-white font-bold py-2 px-4 rounded">
                    Contratos
                </a>
